...
/// Skeleton loading widget matching the pending treatment card layout.
///
...
class PendingTreatmentCardSkeleton extends StatelessWidget {
  /// Creates a [PendingTreatmentCardSkeleton].
  const PendingTreatmentCardSkeleton({super.key});
    ...
    return const HydraCard(
      ...
      child: Row(
        children: [
          ...
          // Text skeletons (medication info)
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Medication name skeleton
                _ShimmerBar(width: 120, height: 18),
                SizedBox(height: 4),

                // Dosage skeleton
                _ShimmerBar(width: 90, height: 16),
                SizedBox(height: 4),

                // Strength skeleton (optional)
          ...
          // Time skeleton
          _ShimmerBar(width: 40, height: 16),
